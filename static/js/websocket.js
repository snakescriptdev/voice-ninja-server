...
class WebSocketClient {
    ...
    async initProtobuf() {
        try{
            ...
            protobuf.load('https://dev.voiceninja.ai/static/frame.proto', (err, root) => {
                if (err) {
    ...
    async connect() {
        try {
            ...
            if (this.ws && this.ws.readyState === WebSocket.OPEN) {
                this.disconnect();
                // this.connectBtn.innerHTML = '<img src="https://dev.voiceninja.ai/static/Web/images/no-microphone.gif" style="width: 35px; height: 35px; object-fit: cover; vertical-align: middle; margin-right: 5px;">';
                return;
            }

            this.updateStatus('connecting', 'Connecting...');
            this.log('Attempting to connect...');
            // this.connectBtn.innerHTML = '<img src="https://dev.voiceninja.ai/static/Web/images/microphone.gif" style="width: 35px; height: 35px; object-fit: cover; vertical-align: middle; margin-right: 5px;">';
            
            // Use dynamic WebSocket URL
            // const authHeader = this.getAuthHeader();
            // const voice = this.get_voice();
            const wsUrl = `wss://${this.BASE_URL}/ws/agent_ws/?agent_id=${this.agentId}`;
