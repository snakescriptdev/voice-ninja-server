...
#                                     // Get selected language or default to English
#                                     const selectedLanguage = window.selectedLanguage || 'en';
#                                     console.log("Creating ElevenLabs client for agent:", window.elevenLabsAgentId, "with language:", selectedLanguage);
#                                     window.elevenLabsClient = new ElevenLabsWebSocketClient(window.elevenLabsAgentId, selectedLanguage);
#                                 }}
